...
class AuthController extends Controller
{
    ...
    public function me(Request $request)
    {
        ...
        // The node code does a slightly different fetch for me. Actually it returns what's in req.user which is generated by findAuthUserById.
        // Node: d.full_name AS customer_full_name
        $customerFullName = DB::table('doctors')->where('user_id', $user->id)->value('full_name');

        $formatted = $this->formatUser($user);
        $formatted['customer_full_name'] = $customerFullName;
